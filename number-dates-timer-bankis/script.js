...
const account1 = {
  ...
  movementsDates: [
    ...
    '2022-05-29T09:15:04.904Z',
    '2022-06-02T10:17:24.185Z',
    '2022-06-04T23:36:17.929Z',
    '2022-06-06T10:51:36.790Z',
    '2022-06-07T11:11:41.604Z',
...
const account2 = {
  ...
  movementsDates: [
    ...
    '2022-06-06T18:49:59.371Z',
    '2022-06-07T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    console.log(locale);
    // labelDate.textContent = new Intl.DateTimeFormat(en-GB, options).format(nows);
    labelDate.textContent = new Intl.DateTimeFormat(
      currentAccount.locale,
      options
    ).format(nows);

    // // create current date amd time
    // const nows = new Date();
...
// use ds to check if a value is a number
...
console.log(2462810183196264542648920n);
console.log(BigInt(48384302));

// operations
console.log(10000n + 10000n);
console.log(2731368123465231910133718864n * 1000000000n);

// doesnt work for math operations
// console.log(Math.sqrt(25n));

const huge = 1244987564783907474833n;
const num = 23;
...
console.log(new Date(`Jun 06 2022 17:20:59`));
console.log(new Date(`april 1 2002`));
...
// intternalizing numbers
const numb = 3884764.23;

const option = {
  // for style we have unit , percent and currency
  style: `currency`,
  unit: `celsius`,
  currency: `EUR`,
  // useGrouping: false,
